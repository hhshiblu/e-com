      ...
      <div className=" !overflow-hidden px-5 ">
        {open && (
          <div className="fixed w-full h-screen bg-[#0000004b] top-0 left-0 flex items-center justify-center ">
            <div className="w-[90%] 800px:w-[60%] h-[80vh]   bg-white rounded shadow relative overflow-y-scroll  800px:mt-20 ">
        ...
        <div className="flex w-full items-center justify-between">
          <h1 className="sm:text-sm md:text-lg font-[600] text-[#000000ba] pb-2">
            My Addresses
          </h1>
          <div
