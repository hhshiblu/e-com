...
const AdminSideBar = ({ active }) => {
  ...
  return (
    <div className="w-full h-[90vh] bg-[#150939] shadow-sm overflow-y-scroll sticky top-0 left-0 z-10">
      ...
      <div className="w-full flex items-center p-4">
        <Link to="/admin-hero-section" className="w-full flex items-center">
          <FiShoppingBag
            size={30}
      ...
      <div className="w-full flex items-center p-4">
        <Link to="/admin-up-items" className="w-full flex items-center">
          <FiShoppingBag
            size={30}
      ...
      <div className="w-full flex items-center p-4">
        <Link to="/admin-sellers" className="w-full flex items-center">
          ...
          <h5
            className={`hidden 800px:block pl-2 text-[18px] font-[400] ${
              active === 5 ? "text-[crimson]" : "text-[#ffffff]"
            }`}
          >
            All Sellers
          </h5>
      ...
      <div className="w-full flex items-center p-4">
        <Link to="/admin-users" className="w-full flex items-center">
          ...
          <h5
            className={`hidden 800px:block pl-2 text-[18px] font-[400] ${
              active === 6 ? "text-[crimson]" : "text-[#ffffff]"
            }`}
          >
            All Users
          </h5>
      ...
      <div className="w-full flex items-center p-4">
        <Link to="/admin-products" className="w-full flex items-center">
          <BsHandbag size={30} color={`${active === 7 ? "crimson" : "#555"}`} />
          <h5
            className={`hidden 800px:block pl-2 text-[18px] font-[400] ${
